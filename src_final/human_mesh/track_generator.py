...
# OUTPUT_DIR = "videos/ucf101/tracked_runway_gen3_alpha_videos"
# videos = os.listdir(DIR)
# actions = os.listdir(DIR)
...
# OUTPUT_DIR = "videos/ucf101/tracked_hunyuan_360p_videos"
# videos = os.listdir(DIR)
# actions = os.listdir(DIR)
...
# OUTPUT_DIR = "videos/ucf101/tracked_opensora_256p_videos"
# videos = os.listdir(DIR)
# actions = os.listdir(DIR)
