...
# DIR = "/projectnb/ivc-ml/xthomas/RESEARCH/video_evals/video-gen-evals/videos_T2V/wan21"
# OUTPUT_DIR = "/projectnb/ivc-ml/xthomas/RESEARCH/video_evals/video-gen-evals/videos_T2V/t2v_mesh_wan21"
...
#     videos = sorted(os.listdir(os.path.join(DIR, action)))
#     for video in videos:
...
# actions = os.listdir(DIR)
# # actions = ["BodyWeightSquats", "HulaHoop", "JumpingJack", "PullUps", "PushUps", "Shotput", "SoccerJuggling", "TennisSwing", "ThrowDiscus", "WallPushups"]
# actions = ["BoxingPunchingBag", "CleanAndJerk", "GolfSwing"]
# actions += ["HandstandPushups", "JugglingBalls", "TableTennisShot"]
# actions += ["TrampolineJumping", "WritingOnBoard", "PlayingViolin", "PlayingCello"]
# actions = ["Lunges"]
# for action in actions:
