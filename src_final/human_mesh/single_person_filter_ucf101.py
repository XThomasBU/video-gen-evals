...
BASE = "results_single_ucf101_DET2"
...
def main():
    ...
    DIR = "/projectnb/ivc-ml/xthomas/RESEARCH/video_evals/video-gen-evals/saved_data/ucf101"
    OUTPUT_JSON_SINGLE = "ucf101_single_person_videos.json"
    OUTPUT_JSON_NOT = "ucf101_not_single_videos.json"
    OUTPUT_JSON_ERRS = "ucf101_errors.json"  # optional but handy
    BGR2RGB = False
