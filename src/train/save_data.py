...
def main():
    ...
    torch.save(train_dataset.window_ids, f"SAVE_NEW/train_window_ids_window_{WINDOW_SIZE}_stride_{STRIDE}_valid_window.pt")
    torch.save(test_dataset.window_ids, f"SAVE_NEW/test_window_ids_window_{WINDOW_SIZE}_stride_{STRIDE}_valid_window.pt")
